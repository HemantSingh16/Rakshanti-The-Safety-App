...
if(isset($_POST['signup'])){
    ...
    if(isset($_POST['check'])){
        ...
        if(mysqli_num_rows($code_res) > 0){
            ...
            $Login_id1 = $fetch_data['id'];
            //$_SESSION['L_id']=$Login_id1;
            $Registered_status = $fetch_data['RegistrationStatus'];
            $code = 0;
            $status = 'verified';
    ...
    if(isset($_POST['login'])){
        ...
        if(mysqli_num_rows($res) > 0){
            ...
            $Login_id = $fetch['id'];
            $RegisteredStatus=$fetch['RegistrationStatus'];
